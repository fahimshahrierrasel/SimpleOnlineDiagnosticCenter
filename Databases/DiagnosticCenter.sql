...
--
-- Host: localhost:8889
-- Generation Time: Aug 02, 2017 at 03:41 AM
...
(1, 'Prof. Dr. Md. Julhash Uddin', 'Medicine', 'Medicine', 'MBBS, FCPS, FCCP, FRCP (Glasgo)', 4),
...
(1, 'Siddikur Rahman', 'X-Ray', 'X-Ray', 9);
...
(1, 'Md. Fahim Shahrier Rasel', 'Male', NULL, NULL, NULL, NULL, 1),
...
(1, 'fahim', 'asdfqwer', 'fahim@tb.com', 1, NULL, 'Patient'),
...
(9, 'siddikurrahman', 'asdfqwer', 'siddikrahman@tb.com', 1, NULL, 'Pathologist'),
...
--
ALTER TABLE `Appointment`
  MODIFY `idAppointment` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
...
--
ALTER TABLE `PrescribedMedicine`
  MODIFY `idPrescribedMedicine` int(11) NOT NULL AUTO_INCREMENT;
--
